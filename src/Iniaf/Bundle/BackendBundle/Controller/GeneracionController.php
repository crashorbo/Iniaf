...
class GeneracionController extends Controller
{
    public function indexAction()
    {
        ...
        return $this->render('BackendBundle:Generacion:index.html.twig', array(
            'entities'      =>  $entities,
    ...
    public function crearAction(Request $request)
    {
        ...
        return $this->redirect($this->generateUrl('backend_generacion_home'));
    }
    ...
    public function gencatAction(Request $request)
    {
        ...
        return $this->render('BackendBundle:Generacion:categorias.html.twig', array(
    ...
    public function filtrogencatAction(Request $request)
    {
        ...
        return $this->render('BackendBundle:Generacion:filtrogencat.html.twig', array(
            'categorias' => $categorias
        ));
    }
    ...
    public function filtrogengenAction(Request $request)
    {
        ...
        return $this->render('BackendBundle:Generacion:filtrogengen.html.twig', array(
